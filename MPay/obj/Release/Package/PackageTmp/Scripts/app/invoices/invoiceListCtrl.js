(function (){
    'use strict';
    angular.module('mpayModule').controller('InvoiceListCtrl', ["$scope", "$state", "scheduleSvc", "uiGridConstants", InvoiceListCtrl]);

    function InvoiceListCtrl($scope, $state, scheduleSvc, uiGridConstant) {
        var vm = this;
        vm.querySt = function () {
